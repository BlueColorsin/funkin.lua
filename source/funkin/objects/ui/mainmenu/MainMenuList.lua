...
---
local MainMenuButton = Flora.import("funkin.objects.ui.mainmenu.MainMenuButton")

---
--- @class funkin.objects.ui.mainmenu.MainMenuList : flora.display.Group
---
...
---
--- @return funkin.objects.ui.mainmenu.MainMenuButton
---
