---
--- @type funkin.objects.ui.alphabet.AlphabetGlyph
---
local AlphabetGlyph = Flora.import("funkin.objects.ui.alphabet.AlphabetGlyph")

---
--- @class funkin.objects.ui.alphabet.Alphabet : flora.display.SpriteGroup
---
...
function Alphabet:get_width()
    if self.group.length > 0 then
        return (self:_findMaxXHelper() - self:_findMinXHelper()) * self.scale.x
    end
    return 0.0
end
...
function Alphabet:get_height()
    if self.group.length > 0 then
        return (self:_findMaxYHelper() - self:_findMinYHelper()) * self.scale.y
    end
    return 0.0
end
